...
#BOT FILE NAME
from DARK import app as app
from DARK.mongo.couples_db import _get_image, get_couple
...
async def ctest(_, message):
    ...
    try:
     ...
     #  if not is_selected:
         msg = await message.reply_text("𝗚𝗘𝗡𝗘𝗥𝗔𝗧𝗜𝗡𝗚 𝗢𝗨𝗥 𝗟𝗢𝗩𝗘𝗟𝗬 𝗖𝗢𝗨𝗣𝗟𝗘𝗦...")
         #GET LIST OF USERS
         list_of_users = []
         ...
         try:
            ...
            p1 = "DARK/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "DARKBOTS/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("DARK/assets/cppic.png")
