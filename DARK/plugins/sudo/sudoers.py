...
from DARK.utils.database import add_sudo, remove_sudo
from DARK.utils.decorators.language import language
from DARK.utils.extraction import extract_user
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("ʙʜᴀɪ ʙʜᴀɪ ʏᴇʜ ɴᴀʜɪ ᴅɪᴋʜᴀᴜɴɢᴀ😂 \n 𝗦ᴜᴅᴏʟɪsᴛ 𝗗ᴇᴋʜɴᴇ ᴀᴀʏᴀ 🤧", show_alert=True)
    else:
